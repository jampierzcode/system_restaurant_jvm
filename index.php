...
?>
  ...
  <body>
    <div class="login-container flex-h-jc">
      <form class="flex-v" action="controlador/LoginController.php" method="post">
        ...
        <div class="box-input-date flex-h">
          ...
          <input class="bg-transparent" name="usuario" type="text" placeholder="Ingrese el nombre del usuario" />
        </div>
        <span>Password</span>
        <div class="box-input-date flex-h">
          <div class="box-icon">
